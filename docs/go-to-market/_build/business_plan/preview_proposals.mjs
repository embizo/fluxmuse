...
try {
  for (const f of readdirSync(dir).filter((n) => n.endsWith('.html'))) {
    ...
    const footer = `<div style="font-family:Arial;font-size:7px;color:#5B6570;width:100%;text-align:center">Fluxmuse Pty Ltd · fluxmuse.ai · Business plan · Confidential · Page <span class="pageNumber"></span> of <span class="totalPages"></span></div>`;
